...
public class UrlServiceImpl implements UrlService {
        ...
        for (int attempt = 1; attempt <= MAX_RETRY; attempt++) {
            ...
            try {
                ...
                return CreateUrlResponse.builder()
                        ...
                        .expiresAt(entity.getExpiresAt().toString()).build();
    ...
    private String validateAndNormalize(CreateUrlRequest request) {
        ...
        if(normalizedLongUrl.length() > MAX_ALLOWED_CHARACTERS) {
            throw new IllegalArgumentException("Url" + normalizedLongUrl +
                    "is longer then maximum allowed characters: " + MAX_ALLOWED_CHARACTERS);
        }
